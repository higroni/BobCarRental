@echo off
REM Clean Database and Restart Application
REM This script deletes the H2 database and restarts the application
REM Hibernate will recreate the database with correct schema
...
echo All data will be lost and recreated from seed data.
echo.
